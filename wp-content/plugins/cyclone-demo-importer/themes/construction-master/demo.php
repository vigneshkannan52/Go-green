...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'                => __('Construction Master Homepage','cdi'),
            'categories'                      =>  array( 'Free' , 'Homepage' ),
            'local_import_file'               => CDI_PLUGIN_DIR_PATH . '/themes/construction-master/inc/content.xml',
            'local_import_customizer_file'    => CDI_PLUGIN_DIR_PATH . '/themes/construction-master/inc/options.dat',
...
function cdi_after_import_setup( $selected_import ) {
    ...
    switch ( $import_file_name ) {
        ...
        case 'Construction Master Homepage':
            $front_page_id = get_page_by_title( 'Construction Master Homepage' );
            break;
