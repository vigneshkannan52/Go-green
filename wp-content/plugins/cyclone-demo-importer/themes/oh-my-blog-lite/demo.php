...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Oh My Blog Free','cdi'),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/oh-my-blog-lite/inc/content.xml',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/oh-my-blog-lite/inc/options.dat'
        )
    );
}
