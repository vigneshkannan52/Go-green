...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Business Conference Free','cdi'),
            'categories'                   =>  array( 'Free' , 'Homepage' ),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/business-conference/inc/content.xml',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/business-conference/inc/options.dat',
            'import_preview_image_url'     => CDI_PLUGIN_DIR_URL . '/assets/images/business-event/homepage-business-conference.jpg',
            'preview_url'                  => 'https://bizbergthemes.com/business-event-pro/homepage-4/'
        ),
        array(
            'import_file_name'=> __('Epic Business Homepage PRO','cdi'),
...
function cdi_after_import_setup( $selected_import ) {
    ...
    switch ( $import_file_name ) {
        ...
        case 'Business Conference Free':
             $front_page_id = get_page_by_title( 'Business Conference Homepage' );
            break;
