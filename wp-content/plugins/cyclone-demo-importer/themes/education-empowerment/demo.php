...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Education Empowerment Free','cdi'),
            'categories'                   =>  array( 'Free' , 'Homepage' ),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/education-empowerment/inc/content.xml',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/education-empowerment/inc/options.dat',
        ...
        array(
            'import_file_name'=> __('Get Education PRO','cdi'),
        ...
        array(
            'import_file_name'=> __('Education Business PRO','cdi'),
            'categories'      =>  array( 'PRO' , 'Homepage' ),
        ...
        array(
            'import_file_name'=> __('Education Business School PRO','cdi'),
            'categories'      =>  array( 'PRO' , 'Homepage' ),
...
function cdi_after_import_setup( $selected_import ) {
    ...
    switch ( $import_file_name ) {
        ...
        case 'Education Empowerment Free':
             $front_page_id = get_page_by_title( 'Education Empowerment Homepage' );
            break;
