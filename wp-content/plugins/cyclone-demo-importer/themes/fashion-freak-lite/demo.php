...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Fashion Freak Free','cdi'),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/fashion-freak-lite/inc/content.xml',
            'local_import_widget_file'     => CDI_PLUGIN_DIR_PATH . '/themes/fashion-freak-lite/inc/widgets.wie',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/fashion-freak-lite/inc/options.dat'
        )
    );
}
