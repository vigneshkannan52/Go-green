...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Business Consulting Dark Lite','cdi'),
            'categories'                   =>  array( 'Free' , 'Homepage' ),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/business-consulting-dark/inc/content.xml',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/business-consulting-dark/inc/options.dat',
...
function cdi_after_import_setup( $selected_import ) {
    ...
    $footer_menu = get_term_by( 'name', 'Useful Links', 'nav_menu' );
    ...
    switch ( $import_file_name ) {
        ...
        case 'Business Consulting Dark Lite':
             $front_page_id = get_page_by_title( 'Business Consulting Dark Lite' );
            break;
