...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Forever Young Free','cdi'),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/forever-young-lite/inc/content.xml',
            'local_import_widget_file'     => CDI_PLUGIN_DIR_PATH . '/themes/forever-young-lite/inc/widgets.wie',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/forever-young-lite/inc/options.dat'
        )
    );
}
