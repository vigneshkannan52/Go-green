...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Green Wealth Homepage Free','cdi'),
            'categories'                   =>  array( 'Free' , 'Homepage' ),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/green-wealth/inc/content.xml',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/green-wealth/inc/options.dat',
        ...
        array(
            'import_file_name'=> __('Green Globe Homepage PRO','cdi'),
            'categories'      =>  array( 'PRO' , 'Homepage' ),
...
function cdi_after_import_setup( $selected_import ) {
    ...
    switch ( $import_file_name ) {
        ...
        case 'Green Wealth Homepage Free':
             $front_page_id = get_page_by_title( 'Green Wealth Homepage' );
            break;
